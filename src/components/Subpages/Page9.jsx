    ...
    <div className="bg-zinc-950 min-h-screen text-gray-300">
      ...
      >
        ...
        <div className="text-center text-gray-200 px-4 sm:px-6 md:px-8 max-w-4xl relative z-10">
          {/* Main Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
            8 of the Most Shocking Artworks Throughout History
          </h1>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row max-w-7xl mx-auto">
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          <div className="flex-1 py-8 px-4 md:px-8 lg:px-12 max-w-4xl mx-auto">
            <div
              className="relative w-full h-96 mb-10 bg-cover bg-center lg:bg-fixed flex flex-col justify-center items-center"
              style={{ backgroundImage: `url(${td36})` }}
            >
              {/* Semi-transparent black overlay */}
              <div className="absolute inset-0 bg-black opacity-50 z-0"></div>
              ...
              <div className="text-center text-gray-200 px-4 sm:px-6 md:px-8 max-w-4xl relative z-10">
                {/* Main Heading */}
                <h1 className="text-2xl sm:text-2xl md:text-2xl lg:text-3xl font-bold mb-4 leading-tight">
                  JOANNA WELLICK . APRIL 28,2019{" "}
                </h1>
              </div>
            </div>
            <div>
