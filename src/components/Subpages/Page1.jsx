    ...
    <div className="bg-zinc-950 min-h-screen text-gray-300">
      ...
      >
        ...
        <div className="text-center text-gray-200 px-4 sm:px-6 md:px-8 max-w-4xl relative z-10">
          <h1 className="text-3xl sm:text-4xl md:text-3xl lg:text-5xl font-bold mb-4 leading-tight">
            8 Ways to Use Digital Drawing
            <br className="hidden sm:block" /> in the Art Room
          </h1>
        </div>
      </div>
